            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div>
                        <label>Image:</label>
                        <br>
                        <% if (!itemImagePath.equals("")) {%>
                        <form action="viewImage.html" method="post" target="_blank">
                            <input type="hidden" name="listName" value="<%=listName%>">
                            <button type="submit" class="btn" name="itemName" value="<%=itemName%>"><img src="<%=itemImagePath%>" style="max-width: 100%; max-height: 250px;" class="img-thumbnail"/></button>
                        </form>
                        <%}%>
